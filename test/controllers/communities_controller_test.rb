...
class CommunitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post communities_url, params: { community: { description: @community.description, name: @community.name, private: @community.private, promo: @community.promo } }
    end
  ...
  test "should update community" do
    patch community_url(@community), params: { community: { description: @community.description, name: @community.name, private: @community.private, promo: @community.promo } }
